...
alter table keepcoding.poliza add constraint fk_poliza_aseguradora foreign key (id_aseguradora) references keepcoding.aseguradora(id);
alter table keepcoding.poliza add constraint fk_poliza_vehiculo foreign key (matricula) references keepcoding.vehiculo(matricula);

alter table keepcoding.marca add constraint fk_marca_grupo foreign key (id_grupo) references keepcoding.grupo(id);

alter table keepcoding.modelo add constraint fk_modelo_marca foreign key (id_marca) references keepcoding.marca(id);

alter table keepcoding.vehiculo add constraint fk_vehiculo_modelo foreign key (id_modelo) references keepcoding.modelo(id);
alter table keepcoding.vehiculo add constraint fk_vehiculo_color foreign key (id_color) references keepcoding.color(id);

alter table keepcoding.revision add constraint fk_revision_vehiculo foreign key (matricula) references keepcoding.vehiculo(matricula);
alter table keepcoding.revision add constraint fk_revision_moneda foreign key (id_moneda) references keepcoding.moneda(id);


CREATE TABLE keepcoding.tmp_coches (
...
INSERT INTO keepcoding.tmp_coches (matricula,grupo,marca,modelo,fecha_compra,color,aseguradora,n_poliza,fecha_alta_seguro,importe_revision,moneda,kms_revision,fecha_revision,kms_totales) VALUES
	 ...
	 ('2438GSV','PSA Peugeot S.A.','Citro�n','DS4','2010-04-17','Gris Plateado','Allianz',195443,'2010-04-17',734.7,'D�lar',12028,'2010-05-13',52349),
	 ('2438GSV','PSA Peugeot S.A.','Citro�n','DS4','2010-04-17','Gris Plateado','Axa',110761,'2011-08-23',460.0,'Euro',28312,'2016-05-17',52349),
	 ...
	 ('6756GXW','PSA Peugeot S.A.','Peugeot','206','2011-07-19','Negro','Mapfre',142266,'2011-07-19',697.5,'D�lar',50738,'2012-04-02',112881),
	 ...
	 ('4325KMF','PSA Peugeot S.A.','Citro�n','DS4','2020-04-13','Blanco','Mapfre',12534,'2020-04-13',7912.8,'Peso Mexicano',20410,'2022-07-08',49476),
	 ...
	 ('3242GQG','Renault-Nissan-Mitsubishi Alliance','Renault','Megane','2013-03-06','Rojo','Mapfre',183813,'2013-03-06',120.9,'D�lar',16209,'2014-02-10',77662),
	 ...
	 ('5426HDG','Hyundai Motor Group','Kia','Ceed','2015-04-01','Negro','Axa',144573,'2015-04-01',437.1,'D�lar',16879,'2015-09-27',46759),
	 ...
	 ('6231KKQ','Renault-Nissan-Mitsubishi Alliance','Dacia','Duster','2019-04-10','Rojo','Allianz',34218,'2019-04-10',632.4,'D�lar',13755,'2021-04-04',39563),
	 ...
	 ('3313GGW','PSA Peugeot S.A.','Citro�n','DS4','2013-04-01','Rojo','Mapfre',85225,'2013-04-01',1884.0,'Peso Mexicano',17187,'2017-12-13',35823),
	 ...
	 ('6642GZP','Hyundai Motor Group','Hyundai','Tucson','2010-04-21','Verde','Mapfre',151249,'2010-04-21',83.7,'D�lar',49405,'2011-05-04',97183),
	 ...
	 ('5303DCG','PSA Peugeot S.A.','Citro�n','DS4','2007-08-30','Gris Plateado','Allianz',79203,'2007-08-30',11492.4,'Peso Mexicano',14181,'2022-05-31',35530),
	 ('0827DBB','Renault-Nissan-Mitsubishi Alliance','Renault','Megane','2006-07-24','Gris Plateado','Generali',40647,'2006-07-24',325.5,'D�lar',24407,'2019-02-23',39061),
	 ('5047FJK','PSA Peugeot S.A.','Citro�n','DS4','2009-10-26','Blanco','Mapfre',172625,'2009-10-26',5086.8,'Peso Mexicano',18053,'2010-02-22',90641),
	 ('5047FJK','PSA Peugeot S.A.','Citro�n','DS4','2009-10-26','Blanco','Mapfre',172625,'2009-10-26',399.9,'D�lar',40390,'2010-05-03',90641),
	 ('5047FJK','PSA Peugeot S.A.','Citro�n','DS4','2009-10-26','Blanco','Mapfre',161701,'2010-10-16',2324230.2,'Peso Colombiano',63099,'2010-12-08',90641),
	 ('4366GZX','Hyundai Motor Group','Hyundai','Tucson','2013-11-03','Verde','Axa',40977,'2013-11-03',306.9,'D�lar',21132,'2017-08-27',44510),
	 ...
	 ('7561CND','Hyundai Motor Group','Hyundai','i30','2004-09-22','Blanco','Mapfre',172754,'2006-03-23',74.4,'D�lar',42110,'2021-04-19',71901),
	 ...
	 ('9157JVM','PSA Peugeot S.A.','Citro�n','Berlingo','2017-09-18','Blanco','Allianz',96770,'2017-09-18',390.6,'D�lar',21421,'2020-12-29',41539),
	 ...
	 ('0366CKQ','PSA Peugeot S.A.','Peugeot','5008','2003-04-10','Gris Plateado','Axa',172546,'2003-04-10',83.7,'D�lar',74997,'2004-04-27',118687),
	 ('0366CKQ','PSA Peugeot S.A.','Peugeot','5008','2003-04-10','Gris Plateado','Allianz',111429,'2004-05-29',548.7,'D�lar',90943,'2009-06-04',118687),
	 ('2907GNT','Hyundai Motor Group','Hyundai','i30','2012-11-08','Negro','Mapfre',92532,'2012-11-08',753.3,'D�lar',25366,'2016-03-09',51508),
	 ('2428HYB','Renault-Nissan-Mitsubishi Alliance','Renault','Megane','2014-12-04','Verde','Generali',181054,'2014-12-04',269.7,'D�lar',17526,'2014-12-09',87006),
	 ...
	 ('2428HYB','Renault-Nissan-Mitsubishi Alliance','Renault','Megane','2014-12-04','Verde','Axa',161471,'2015-10-15',399.9,'D�lar',72001,'2016-05-24',87006),
	 ...
	 ('5022JZD','Hyundai Motor Group','Hyundai','i30','2016-03-07','Verde','Axa',191842,'2017-08-09',539.4,'D�lar',35020,'2021-04-19',63426),
	 ...
	 ('8177JPM','Renault-Nissan-Mitsubishi Alliance','Renault','Clio','2016-11-27','Gris Plateado','Allianz',119373,'2016-11-27',483.6,'D�lar',41924,'2017-11-25',77082),
	 ...
	 ('8627FRY','Hyundai Motor Group','Hyundai','Tucson','2008-04-02','Blanco','Mapfre',51353,'2008-04-02',120.9,'D�lar',16181,'2020-04-28',30083),
	 ('7938HXH','Hyundai Motor Group','Hyundai','Tucson','2015-10-24','Gris Plateado','Mapfre',163498,'2015-10-24',186.0,'D�lar',20157,'2016-09-08',53342),
	 ...
	 ('3230KTX','Renault-Nissan-Mitsubishi Alliance','Nissan','Qashqai','2019-04-16','Negro','Axa',127909,'2020-09-18',688.2,'D�lar',44068,'2023-02-02',69200),
	 ...
	 ('4221JXR','Hyundai Motor Group','Kia','Rio','2018-03-19','Azul','Generali',109846,'2019-03-11',204.6,'D�lar',38809,'2022-05-22',50166),
	 ...
	 ('1621CSY','PSA Peugeot S.A.','Citro�n','DS4','2004-10-12','Rojo','Mapfre',89394,'2004-10-12',4898.4,'Peso Mexicano',29407,'2022-08-18',42218),
	 ...
	 ('9412DTS','PSA Peugeot S.A.','Citro�n','DS4','2007-01-31','Negro','Generali',82043,'2007-01-31',46.5,'D�lar',24707,'2015-05-30',54013),
	 ...
	 ('9729KXJ','Renault-Nissan-Mitsubishi Alliance','Renault','Megane','2020-09-06','Verde','Allianz',184039,'2020-09-06',632.4,'D�lar',36512,'2021-09-13',76972),
	 ...
	 ('2890DSR','Hyundai Motor Group','Kia','Ceed','2006-07-13','Gris Plateado','Allianz',16848,'2006-07-13',213.9,'D�lar',13864,'2014-07-23',28530),
	 ('2066BYF','PSA Peugeot S.A.','Citro�n','Berlingo','1999-03-14','Gris Plateado','Axa',105112,'1999-03-14',1162115.1,'Peso Colombiano',14097,'1999-09-04',57697),
	 ('2066BYF','PSA Peugeot S.A.','Citro�n','Berlingo','1999-03-14','Gris Plateado','Generali',126373,'2000-01-12',559536.9,'Peso Colombiano',28378,'2014-05-14',57697),
	 ...
	 ('7466DMG','Renault-Nissan-Mitsubishi Alliance','Renault','Clio','2007-03-31','Gris Plateado','Allianz',145462,'2007-03-31',325.5,'D�lar',39863,'2007-09-26',85722),
	 ...
	 ('0390DRK','PSA Peugeot S.A.','Citro�n','DS4','2007-03-27','Verde','Axa',121129,'2008-05-01',6594.0,'Peso Mexicano',22339,'2015-12-01',38651),
	 ...
	 ('3960JYB','Renault-Nissan-Mitsubishi Alliance','Renault','Kangoo','2017-09-15','Negro','Mapfre',8307,'2017-09-15',158.1,'D�lar',17211,'2018-08-22',30810),
	 ...
	 ('2684FZV','PSA Peugeot S.A.','Citro�n','DS4','2008-05-10','Negro','Mapfre',50387,'2008-05-10',455.7,'D�lar',17713,'2008-06-07',36859);
INSERT INTO keepcoding.tmp_coches (matricula,grupo,marca,modelo,fecha_compra,color,aseguradora,n_poliza,fecha_alta_seguro,importe_revision,moneda,kms_revision,fecha_revision,kms_totales) VALUES
	 ...
	 ('5751FCL','Hyundai Motor Group','Kia','Ceed','2008-07-30','Rojo','Allianz',4341,'2008-07-30',446.4,'D�lar',16314,'2010-08-06',40662),
	 ...
	 ('2874BRD','Hyundai Motor Group','Hyundai','i30','2000-10-01','Azul','Mapfre',115392,'2002-01-17',232.5,'D�lar',27678,'2021-12-22',46794),
	 ...
	 ('2430FDP','PSA Peugeot S.A.','Citro�n','Berlingo','2008-06-23','Negro','Generali',118284,'2008-06-23',530.0,'Euro',29114,'2009-07-10',91570),
	 ('2430FDP','PSA Peugeot S.A.','Citro�n','Berlingo','2008-06-23','Negro','Generali',118284,'2008-06-23',3228097.5,'Peso Colombiano',53723,'2009-08-21',91570),
	 ('2430FDP','PSA Peugeot S.A.','Citro�n','Berlingo','2008-06-23','Negro','Generali',137325,'2009-10-14',770.0,'Euro',66643,'2011-11-06',91570),
	 ...
	 ('4916HJG','Renault-Nissan-Mitsubishi Alliance','Nissan','Qashqai','2015-03-29','Azul','Allianz',163789,'2016-01-31',46.5,'D�lar',39243,'2023-08-26',64638),
	 ...
	 ('8540DXG','Hyundai Motor Group','Hyundai','Tucson','2007-03-13','Gris Plateado','Axa',71232,'2007-03-13',530.1,'D�lar',15249,'2014-01-12',27722),
	 ...
	 ('6335BFK','Renault-Nissan-Mitsubishi Alliance','Dacia','Duster','1999-06-06','Verde','Allianz',177717,'2000-05-01',279.0,'D�lar',34682,'2009-04-14',53657),
	 ...
	 ('7631GCM','PSA Peugeot S.A.','Citro�n','DS4','2011-09-17','Negro','Allianz',63946,'2011-09-17',830.0,'Euro',15837,'2021-11-16',31372),
	 ...
	 ('7489HBJ','Renault-Nissan-Mitsubishi Alliance','Renault','Kangoo','2014-10-11','Rojo','Axa',82585,'2014-10-11',316.2,'D�lar',22207,'2019-08-02',37783),
	 ...
	 ('7136BCS','PSA Peugeot S.A.','Peugeot','206','2001-02-09','Blanco','Generali',6062,'2001-02-09',595.2,'D�lar',22625,'2003-10-29',43363),
	 ...
	 ('2835JQN','Renault-Nissan-Mitsubishi Alliance','Renault','Kangoo','2016-11-16','Rojo','Allianz',108872,'2018-05-12',669.6,'D�lar',45588,'2021-08-01',61510),
	 ...
	 ('8217BCW','PSA Peugeot S.A.','Citro�n','DS4','2001-12-18','Rojo','Mapfre',194490,'2003-07-13',620.0,'Euro',25009,'2020-05-08',43385),
	 ('0326HRM','PSA Peugeot S.A.','Peugeot','5008','2014-06-28','Gris Plateado','Axa',179156,'2014-06-28',827.7,'D�lar',20625,'2015-05-30',105374),
	 ('0326HRM','PSA Peugeot S.A.','Peugeot','5008','2014-06-28','Gris Plateado','Axa',179156,'2014-06-28',548.7,'D�lar',46451,'2015-06-11',105374),
	 ('0326HRM','PSA Peugeot S.A.','Peugeot','5008','2014-06-28','Gris Plateado','Axa',179156,'2014-06-28',350.0,'Euro',62529,'2015-06-18',105374),
	 ('0326HRM','PSA Peugeot S.A.','Peugeot','5008','2014-06-28','Gris Plateado','Generali',187973,'2015-06-19',241.8,'D�lar',90819,'2016-08-25',105374),
	 ...
	 ('5572DHP','Hyundai Motor Group','Kia','Rio','2007-06-06','Blanco','Axa',75790,'2007-06-06',186.0,'D�lar',22437,'2014-05-29',42143);

insert into keepcoding.grupo (nombre)
select grupo from keepcoding.tmp_coches group by grupo;

insert into keepcoding.marca (id_grupo, nombre)
select g.id, tmp.marca from keepcoding.tmp_coches tmp 
inner join keepcoding.grupo g on g.nombre = tmp.grupo 
group by g.id, tmp.marca;

insert into keepcoding.modelo (id_marca, nombre)
select m.id, tmp.modelo from keepcoding.tmp_coches tmp 
inner join keepcoding.grupo g on g.nombre = tmp.grupo 
inner join keepcoding.marca m on m.nombre = tmp.marca
group by g.id, m.id, tmp.modelo;

insert into keepcoding.aseguradora (nombre)
select aseguradora from keepcoding.tmp_coches group by aseguradora;

insert into keepcoding.color (nombre)
select color from keepcoding.tmp_coches group by color;

insert into keepcoding.moneda (nombre)
select moneda from keepcoding.tmp_coches group by moneda;

insert into keepcoding.vehiculo (matricula, fecha_compra, id_modelo, id_color, kms_totales)
select matricula, fecha_compra, md.id, c.id, kms_totales from keepcoding.tmp_coches tmp
inner join keepcoding.grupo g on g.nombre = tmp.grupo 
inner join keepcoding.marca m on m.nombre = tmp.marca
inner join keepcoding.modelo md on md.nombre = tmp.modelo
inner join keepcoding.color c on c.nombre = tmp.color
group by matricula, fecha_compra, md.id, c.id, kms_totales;

insert into keepcoding.poliza (matricula, id, id_aseguradora, fecha_alta, en_vigor)
select tmp.matricula, tmp.n_poliza, a.id, tmp.fecha_alta_seguro, false  from keepcoding.tmp_coches tmp
inner join keepcoding.aseguradora a on a.nombre = tmp.aseguradora
group by tmp.matricula, tmp.n_poliza, a.id, tmp.fecha_alta_seguro
order by tmp.matricula, tmp.n_poliza;

update keepcoding.poliza p 
set en_vigor = true 
from (select p.matricula, max(p.fecha_alta) max_fecha_alta from keepcoding.poliza p group by p.matricula) pv 
where p.matricula = pv.matricula and p.fecha_alta = pv.max_fecha_alta;

insert into keepcoding.revision (matricula, kms_totales, id_moneda, fecha_revision, importe)
select tmp.matricula, tmp.kms_totales, m.id, tmp.fecha_revision, round(tmp.importe_revision::decimal, 2) from keepcoding.tmp_coches tmp
inner join keepcoding.moneda m on m.nombre = tmp.moneda
group by tmp.matricula, tmp.kms_totales, m.id, tmp.fecha_revision, tmp.importe_revision
order by tmp.matricula;


-- Consulta para obtener informacion de los vehiculos activos
select g.nombre grupo, md.nombre modelo, mr.nombre marca, v.fecha_compra, v.matricula, c.nombre color, v.kms_totales total_kilometros, a.nombre aseguradora, p.id poliza
from keepcoding.vehiculo v
inner join keepcoding.modelo md on md.id = v.id_modelo
inner join keepcoding.marca mr on mr.id = md.id_marca
inner join keepcoding.grupo g on g.id = mr.id_grupo
inner join keepcoding.poliza p on p.matricula = v.matricula and p.en_vigor = true
inner join keepcoding.aseguradora a on a.id = p.id_aseguradora
inner join keepcoding.color c on c.id = v.id_color
